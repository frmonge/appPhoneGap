class Escena extends Phaser.Scene {
    ...
    create() {
		...
		//Variables para el temporizador y llamada al temporizador.
		...
		this.marcador = 0;
        this.marcadorTXT = this.add.text(110, 120, this.marcador, {
            fontFamily: 'font1',
            fontSize: 60,
            color: '#00ff00',
            align: 'right'
		...
		// Segunda parte del marcador, puntos
		this.add.text(115, 150, 'pts', {
            fontFamily: 'font1',
            fontSize: 24,
            color: '#00ff00'
        });
